...
const createUser = asyncHandler(async (req, res) => {
  //get values = require( request body
...
const adminauthUser = asyncHandler(async (req, res) => {
  const { email, password } = req.body
...
module.exports = { authUser,adminauthUser, getUserProfile, createUser, updateUserProfile, getUsers }
